...
//
//	public void accept(LifeVisitor visitor, int n,ArrayList<LifeCommand> commandList) {
//		visitor.visit(this, n ,commandList);
//		
//	}

	public void accept(LifeVisitor visitor, ArrayList<LifeCommand> commandList) {
		cellState.accept(visitor, commandList, this);;		
	}
}